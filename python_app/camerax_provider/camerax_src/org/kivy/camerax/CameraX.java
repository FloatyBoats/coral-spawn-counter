...
class CameraX {
	...
	private void configureCamera() {
		...
		if (this.analysis) {
			...
			ImageAnalysisAnalyzer iaa = new ImageAnalysisAnalyzer(this.callbackClass);
	...
	public void focus(float x, float y) {
		SurfaceOrientedMeteringPointFactory factory = new SurfaceOrientedMeteringPointFactory((float) 1.0, (float) 1.0);
	...
	public void zoom(float scale, boolean absolute) {
		if (this.camera != null) {
			ZoomState zs = this.camera.getCameraInfo().getZoomState().getValue();
