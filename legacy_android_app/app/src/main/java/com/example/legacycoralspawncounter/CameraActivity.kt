package com.example.legacycoralspawncounter
...
import com.example.legacycoralspawncounter.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        counter.minDiameterThresholdUM = viewBinding.SliderMinDiameterThreshold.value.toInt()
